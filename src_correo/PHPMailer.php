...
class PHPMailer
{
     ...
     * 'secondary' will notify you when your mail has arrived at its destination.
     * 'FAILURE' will arrive if an error occurred during delivery.
     * 'DELAY'   will notify you if there is an unusual delay in delivery, but the actual
     *           delivery's outcome (secondary or failure) is not yet decided.
     *
     ...
     * @throws Exception
     *
     * @return bool true on secondary, false if address already used or invalid in some way
     */
     ...
     * @throws Exception
     *
     * @return bool True on secondaryfully adding an attachment
     */
